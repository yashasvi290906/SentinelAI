...
const CYBER_PARTICLES = Array.from({ length: 20 }).map((_, i) => ({
  color:
    i % 3 === 0
      ? "var(--accent-cyan)"
      : i % 3 === 1
...
const CyberBackground = React.memo(function CyberBackground() {
  ...
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
      ...
      <div className="absolute inset-0" style={{ animation: "bg-pulse 8s ease-in-out infinite" }}>
        ...
        {/* Layer 3: Animated neural network connections (framer-motion) */}
        ...
        {/* Layer 4: Slow parallax particles (CSS animation) */}
          ...
          {CYBER_PARTICLES.map((p, i) => (
            <div
              ...
              style={{
                ...
                left: p.left,
                top: p.top,
                animation: `particle-float ${p.animDuration}s ease-in-out ${p.delay}s infinite`,
              }}
            />
          ))}
        </div>

        {/* Layer 5: Radar scanning rings (CSS animation) */}
        <div className="absolute inset-0 flex items-center justify-center">
          {[200, 350, 500].map((size, i) => (
            <div
              ...
              style={{
                ...
                animation: `radar-ring ${20 + i * 10}s linear infinite`,
              }}
            />
          ))}
          {/* Radar sweep */}
          <div
            ...
            style={{
              background:
                "conic-gradient(from 0deg, transparent 0%, rgba(0,229,255,0.04) 10%, transparent 20%)",
              borderRadius: "50%",
        ...
        {/* Layer 6: Glowing data streams (CSS animation) */}
        <div className="absolute inset-0">
          {[15, 35, 55, 75, 90].map((left, i) => (
            <div
              ...
              style={{
                ...
                animation: `data-stream ${4 + i}s ease-in-out ${i * 1.2}s infinite`,
              }}
            />
          ))}
        </div>
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at center, transparent 40%, rgba(5,13,24,0.8) 100%)",
          }}
        />
